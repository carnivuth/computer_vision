...
A good implementation of the Canny edge detector is obtained by [Gaussian filtering](GAUSSIAN%20FILTER.md) followed by [gradient computation](EDGES.md#GRADIENT%20APPROXIMATION) and [NMS](EDGES.md#NON%20MAXIMA%20SUPRESSION%20(NMS)) along the gradient direction
...
A possible improvement can be done by [exploiting the separability](GAUSSIAN%20FILTER.md#EXPLOITING%20SEPARABILITY%20TO%20IMPROVE%20PERFORMANCE) of the 2D Gaussian function
...
![](Pasted%20image%2020240309145141.png)

## FINAL PIPELINE

![](Pasted%20image%2020240309145554.png)
...
This implementation does not perform [Gaussian smoothing](GAUSSIAN%20FILTER.md) before